# HACK(Richo): Added this file from the webots code to be able to bypass some Python bindings 
# that have bugs and call the C library directly. I added it specifically to fix bug #5920,
# which should be fixed in the next version of webots (R2023b) so when we upgrade webots we
# should remove this...
